               ...
               <ul>
                   <li>
                    ...
                    <li>
                            ...
                            <a href="register.php" class="current">SignUp</a>
  ...
  <div class="content">
    <header>SignUp Form</header>
     <form id ="signupForm"  action="register_process.php" method="POST">
      ...
      <div class="field space">
        <span class="fa fa-lock"></span>
        <input type="password" name="rePassword" id="rePassword" class="pass-key" required placeholder="rePassword">
        <span class="show"></span>
      </div>
      <br>
    ...
    <br>
    <div class="signup">Want the home page?
      <a href="index.php">Home</a>
    </div>
  </div>
</div>
